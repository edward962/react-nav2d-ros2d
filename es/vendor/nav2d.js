...
NAV2D.Navigator = function(options) {
  ...
  function sendGoal(pose) {
      ...
      var goalMarker = new ROS2D.NavigationArrow({
          size: 15,
          strokeSize: 2,
          fillColor: createjs.Graphics.getRGB(0, 0, 256, 0.66),
          pulse: true
      });
  ...
  size : 21,
  strokeSize : 2,
  fillColor : createjs.Graphics.getRGB(17, 218, 0, 0.66),
  pulse : true
});
          ...
          if (mouseState === 'down' ) {
              ...
              if (mouseDown === true) {
                  ...
                  orientationMarker = new ROS2D.NavigationArrow({
                      size: 21,
                      strokeSize: 2,
                      fillColor: createjs.Graphics.getRGB(0, 255, 0, 0.36),
                      pulse: false
                  });
  ...
  this.rootObject.addEventListener('stagemouseup', function(event) {
     ...
     this.rootObject.addEventListener("mouseover", function(event){
       this.rootObject.addEventListener("mousewheel", MouseWheelHandler, false);
   this.rootObject.addEventListener("DOMMouseScroll", MouseWheelHandler, false);
     });
   var zoom;
